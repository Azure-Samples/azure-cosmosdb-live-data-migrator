...
namespace Migration.Shared
{
    ...
    internal class DefaultSerializer : CosmosSerializer
    {
        ...
        /// it is easier to convert to System.Text.Json
        /// </remarks>
        internal DefaultSerializer(JsonSerializerSettings jsonSerializerSettings)
        {
        ...
        public override Stream ToStream<T>(T input)
        {
            ...
            using (StreamWriter streamWriter = new StreamWriter(streamPayload, encoding: DefaultSerializer.DefaultEncoding, bufferSize: 1024, leaveOpen: true))
            {
